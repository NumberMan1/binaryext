...
func Test_BufioReader_Uint8(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint8())
		},
	)
}
...
func Test_BufioReader_Uint16BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint16BE())
		},
	)
}
...
func Test_BufioReader_Uint16LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint16LE())
		},
	)
}
...
func Test_BufioReader_Uint24BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint24BE())
		},
	)
}
...
func Test_BufioReader_Uint24LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint24LE())
		},
	)
}
...
func Test_BufioReader_Uint32BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint32BE())
		},
	)
}
...
func Test_BufioReader_Uint32LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint32LE())
		},
	)
}
...
func Test_BufioReader_Uint40BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint40BE())
		},
	)
}
...
func Test_BufioReader_Uint40LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint40LE())
		},
	)
}
...
func Test_BufioReader_Uint48BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint48BE())
		},
	)
}
...
func Test_BufioReader_Uint48LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint48LE())
		},
	)
}
...
func Test_BufioReader_Uint56BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint56BE())
		},
	)
}
...
func Test_BufioReader_Uint56LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint56LE())
		},
	)
}
...
func Test_BufioReader_Uint64BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint64BE())
		},
	)
}
...
func Test_BufioReader_Uint64LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUint64LE())
		},
	)
}
...
func Test_BufioReader_UintBE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUintBE())
		},
	)
}
...
func Test_BufioReader_UintLE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUintLE())
		},
	)
}
...
func Test_BufioReader_Uvarint(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadUvarint())
		},
	)
}
...
func Test_BufioReader_Varint(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadVarint())
		},
	)
}
...
func Test_BufioReader_Float32BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadFloat32BE())
		},
	)
}
...
func Test_BufioReader_Float32LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadFloat32LE())
		},
	)
}
...
func Test_BufioReader_Float64BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadFloat64BE())
		},
	)
}
...
func Test_BufioReader_Int8(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt8())
		},
	)
}
...
func Test_BufioReader_Int16BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt16BE())
		},
	)
}
...
func Test_BufioReader_Int16LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt16LE())
		},
	)
}
...
func Test_BufioReader_Int24BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt24BE())
		},
	)
}
...
func Test_BufioReader_Int24LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt24LE())
		},
	)
}
...
func Test_BufioReader_Int32BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt32BE())
		},
	)
}
...
func Test_BufioReader_Int32LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt32LE())
		},
	)
}
...
func Test_BufioReader_Int40BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt40BE())
		},
	)
}
...
func Test_BufioReader_Int40LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt40LE())
		},
	)
}
...
func Test_BufioReader_Int48BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt48BE())
		},
	)
}
...
func Test_BufioReader_Int48LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt48LE())
		},
	)
}
...
func Test_BufioReader_Int56BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt56BE())
		},
	)
}
...
func Test_BufioReader_Int56LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt56LE())
		},
	)
}
...
func Test_BufioReader_Int64BE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt64BE())
		},
	)
}
...
func Test_BufioReader_Int64LE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadInt64LE())
		},
	)
}
...
func Test_BufioReader_IntBE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadIntBE())
		},
	)
}
...
func Test_BufioReader_IntLE(t *testing.T) {
	...
	BufioReaderTest(t,
		...
		func(r BinaryReader) {
			unittest.EqualNow(t, <-c, r.ReadIntLE())
		},
	)
}
