...
func Test_PutGet(t *testing.T) {
	...
	unittest.EqualNow(t, GetUintLE(x, 2), 0xAABB)
	unittest.EqualNow(t, GetUint16LE(x), 0xAABB)
	unittest.EqualNow(t, binary.LittleEndian.Uint16(x), 0xAABB)

	PutUintBE(x, 2, uint64(0xAABB))
	unittest.EqualNow(t, GetUintBE(x, 2), 0xAABB)
	unittest.EqualNow(t, GetUint16BE(x), 0xAABB)
	unittest.EqualNow(t, binary.BigEndian.Uint16(x), 0xAABB)

	PutUintLE(x, 3, uint64(0xAABBCC))
	unittest.EqualNow(t, GetUintLE(x, 3), 0xAABBCC)
	unittest.EqualNow(t, GetUint24LE(x), 0xAABBCC)

	PutUintBE(x, 3, uint64(0xAABBCC))
	unittest.EqualNow(t, GetUintBE(x, 3), 0xAABBCC)
	unittest.EqualNow(t, GetUint24BE(x), 0xAABBCC)

	PutUintLE(x, 4, uint64(0xAABBCCDD))
	unittest.EqualNow(t, GetUintLE(x, 4), 0xAABBCCDD)
	unittest.EqualNow(t, GetUint32LE(x), 0xAABBCCDD)
	unittest.EqualNow(t, binary.LittleEndian.Uint32(x), 0xAABBCCDD)

	PutUintBE(x, 4, uint64(0xAABBCCDD))
	unittest.EqualNow(t, GetUintBE(x, 4), 0xAABBCCDD)
	unittest.EqualNow(t, GetUint32BE(x), 0xAABBCCDD)
	unittest.EqualNow(t, binary.BigEndian.Uint32(x), 0xAABBCCDD)

	PutUintLE(x, 5, uint64(0xAABBCCDDEE))
	unittest.EqualNow(t, GetUintLE(x, 5), 0xAABBCCDDEE)
	unittest.EqualNow(t, GetUint40LE(x), 0xAABBCCDDEE)

	PutUintBE(x, 5, uint64(0xAABBCCDDEE))
	unittest.EqualNow(t, GetUintBE(x, 5), 0xAABBCCDDEE)
	unittest.EqualNow(t, GetUint40BE(x), 0xAABBCCDDEE)

	PutUintLE(x, 6, uint64(0xAABBCCDDEEFF))
	unittest.EqualNow(t, GetUintLE(x, 6), 0xAABBCCDDEEFF)
	unittest.EqualNow(t, GetUint48LE(x), 0xAABBCCDDEEFF)

	PutUintBE(x, 6, uint64(0xAABBCCDDEEFF))
	unittest.EqualNow(t, GetUintBE(x, 6), 0xAABBCCDDEEFF)
	unittest.EqualNow(t, GetUint48BE(x), 0xAABBCCDDEEFF)

	PutUintLE(x, 7, uint64(0xAABBCCDDEEFF00))
	unittest.EqualNow(t, GetUintLE(x, 7), 0xAABBCCDDEEFF00)
	unittest.EqualNow(t, GetUint56LE(x), 0xAABBCCDDEEFF00)

	PutUintBE(x, 7, uint64(0xAABBCCDDEEFF00))
	unittest.EqualNow(t, GetUintBE(x, 7), 0xAABBCCDDEEFF00)
	unittest.EqualNow(t, GetUint56BE(x), 0xAABBCCDDEEFF00)

	PutUintLE(x, 8, uint64(0xAABBCCDDEEFF0011))
	unittest.EqualNow(t, GetUintLE(x, 8), uint64(0xAABBCCDDEEFF0011))
	unittest.EqualNow(t, GetUint64LE(x), uint64(0xAABBCCDDEEFF0011))
	unittest.EqualNow(t, binary.LittleEndian.Uint64(x), uint64(0xAABBCCDDEEFF0011))

	PutUintBE(x, 8, uint64(0xAABBCCDDEEFF0011))
	unittest.EqualNow(t, GetUintBE(x, 8), uint64(0xAABBCCDDEEFF0011))
	unittest.EqualNow(t, GetUint64BE(x), uint64(0xAABBCCDDEEFF0011))
	unittest.EqualNow(t, binary.BigEndian.Uint64(x), uint64(0xAABBCCDDEEFF0011))
}
...
func Test_VarintSize(t *testing.T) {
	...
	for i := 0; i < 100000; i++ {
		...
		size1 := VarintSize(v)
		size2 := PutVarint(b, v)
		unittest.EqualNow(t, size1, size2)
	}
}
